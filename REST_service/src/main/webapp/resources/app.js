...
function display_car(car)
{
	 ...
	 out_data = out_data + "<table bgcolor=eeeeee><tr><td>Auto id: <b>" + car.id + "</b></td></tr>";
		...
		out_data = out_data + "<tr><td>Esitaja:</td><td><input type=text name=make value='" + car.make + "'></td></tr>";
		out_data = out_data + "<tr><td>Lugu:</td><td><input type=text name=model value='" + car.model + "'></td></tr>";
		out_data = out_data + "<tr><td>Žanr:</td><td><input type=text name=series value='" + car.series + "'></td></tr>";
...
{
	var out_data="";
	 out_data = out_data + "<table bgcolor=eeeeee><tr><td>Lood, kokku: <b>" + data.length + "</b></td></tr>";
	 for(var  i in data) {
   	  var car = data[i];
		out_data = out_data + "<tr><td>Esitaja:</td><td>" + car.make + "</td><td>Lugu:</td><td>" + car.model + "</td>";
